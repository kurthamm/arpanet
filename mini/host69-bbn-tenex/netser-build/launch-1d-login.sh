...
W "MOUNT DTA1:" 3
# --- create the non-privileged DEMO login account (cosmetic CAN'T CREATE is OK) ---
: > "$CLOG"
W "RUN DTA1:DLUSER.SAV" 5
W "L" 3                                          # DUMP OR LOAD? -> Load
W "DTA1:DEMUSR.TXT" 6                            # FILE: -> the demo account
W "" 4                                           # let it finish (DONE.)
echo "[T] DLUSER (create DEMO) output:"; tail -14 "$CLOG"
